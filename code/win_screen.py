...
class Win:
    def __init__(self, close_game):
        ...
        self.button = Button((WIDTH/2)-75,(HEIGHT/2)+100,150,50,(0,255,0),"Exit Game", self.display_surface)
    ...
    def create_screen_retry(self):
        ...
        self.image = pygame.image.load('../assets\popup\win.png').convert_alpha()
        ...
        self.draw_text("You defeated the boss.",(255, 255, 255), 20, None, (HEIGHT/2)+60)
        self.button.draw()
